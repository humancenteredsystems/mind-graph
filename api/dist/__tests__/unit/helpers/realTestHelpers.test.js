...
describe('realTestHelpers', () => {
    describe('createTestHierarchyAssignment', () => {
        it('should create assignment object with provided parameters', () => {
            const result = (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', 'test-hierarchy-1', 'dynamic-level-id-456');
        ...
        it('should use default hierarchy when not provided', () => {
            const result = (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', undefined, // TypeScript will complain but test the runtime behavior
        ...
        it('should throw error when levelId is not provided', () => {
            expect(() => {
                (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', 'test-hierarchy-1', '' // Empty string should trigger error
                );
            }).toThrow('levelId is required and must be a real Dgraph-generated ID');
        });
        it('should throw error when levelId is undefined', () => {
            expect(() => {
                (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', 'test-hierarchy-1', undefined // Test undefined levelId
                );
            }).toThrow('levelId is required and must be a real Dgraph-generated ID');
        });
        it('should throw error when levelId is null', () => {
            expect(() => {
                (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', 'test-hierarchy-1', null // Test null levelId
                );
            }).toThrow('levelId is required and must be a real Dgraph-generated ID');
        });
        it('should throw descriptive error referencing Issues #6/#13', () => {
            expect(() => {
                (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', 'test-hierarchy-1', '');
        ...
        it('should work with realistic Dgraph-generated level IDs', () => {
            ...
            const result = (0, realTestHelpers_1.createTestHierarchyAssignment)('test-node-123', 'test-hierarchy-1', dgraphStyleLevelId);
    ...
    describe('createTestNodeData', () => {
        it('should create node data with unique IDs', () => {
            const node1 = (0, realTestHelpers_1.createTestNodeData)();
            const node2 = (0, realTestHelpers_1.createTestNodeData)();
        ...
        it('should apply overrides correctly', () => {
            ...
            const result = (0, realTestHelpers_1.createTestNodeData)(overrides);
