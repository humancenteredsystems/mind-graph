...
import { mockNodes, mockHierarchies } from '../helpers/mockData'; // Will need to migrate mockData.js later
...
describe('GraphQL Integration Tests', () => {
  ...
  describe('Performance and Load Testing', () => {
    ...
    it('should handle concurrent requests', async () => {
      ...
      const requests = Array(5).fill(0).map(() => // Fill with 0 instead of undefined
        request(app)
          .post('/api/query')
          .send({ query })
      );
