...
// Request interfaces for tenant operations
...
export class TenantController {
  ...
  async createTenant(req: CreateTenantRequest, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getTenantInfo(req: TenantParamsRequest, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async deleteTenant(req: TenantParamsRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      const { tenantId } = req.params;
