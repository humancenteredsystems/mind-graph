...
/**
 * List all GitHub issues for the repository
 */
export const listGitHubIssues = async (
  adminKey: string,
  state: 'open' | 'closed' | 'all' = 'open'
): Promise<GitHubIssue[]> => {
  return executeAdminRequest(`/admin/github/issues?state=${state}`, undefined, 'GET', adminKey);
};
...
export const getGitHubIssue = async (
  ...
  return executeAdminRequest(`/admin/github/issues/${issueNumber}`, undefined, 'GET', adminKey);
};
...
export const analyzeIssue = async (
  ...
  return executeAdminRequest(`/admin/github/issues/${issueNumber}/analyze`, undefined, 'GET', adminKey);
};

/**
 * Create a new Cline task with pre-populated context for an issue
 */
export const createClineTaskForIssue = async (
  issueNumber: number,
  adminKey: string
): Promise<{
  success: boolean;
  ...
  return executeAdminRequest('/admin/github/create-cline-task', {
    issueNumber
  }, 'POST', adminKey);
};
...
export const updateGitHubIssue = async (
  ...
  return executeAdminRequest(`/admin/github/issues/${issueNumber}/update`, update, 'POST', adminKey);
};
